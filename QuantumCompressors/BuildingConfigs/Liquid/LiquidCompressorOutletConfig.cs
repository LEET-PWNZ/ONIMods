...
{
    public class LiquidCompressorOutletConfig : IBuildingConfig
    {
        public static string UPPERID { get { return ID.ToUpperInvariant(); } }
        public const string ID = "LiquidCompressorOutlet";
        public const string NAME = "Quantum Liquid Outlet";
        public static string DESC = "Receives a user-selected " + UI.FormatAsLink("liquid", "ELEMENTS_LIQUID") + " type from a " + UI.FormatAsLink(LiquidQuantumCompressorConfig.NAME, LiquidQuantumCompressorConfig.UPPERID) + ".";
